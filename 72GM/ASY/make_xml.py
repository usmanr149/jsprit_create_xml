...
def create_xml_for_turf():
    df = pd.read_csv("/home/usman/PycharmProjects/jsprit_create_xml/72GM/ASY/services_yard_Ambleside Yard")
...
if __name__ == '__main__':
    ...
    xml.append('</problem>')
    #print("\n".join(xml))
    with open('/home/usman/PycharmProjects/jsprit_create_xml/72GM/ASY/problem_setup.xml', 'w') as f:
        f.write("\n".join(xml))
