...
if __name__ == '__main__':
	...
	df = updateInputFile('/home/usman/PycharmProjects/jsprit_create_xml/580D/ODL_Inputs_hold_test.csv',
		df_solution, unassignedJobs, day)
	
	df.drop('Day', axis=1, inplace=True)
	df.drop_duplicates(inplace=True)
	#df.drop_duplicates(subset=['Id'], inplace=True)
	df.to_csv('/home/usman/PycharmProjects/jsprit_create_xml/580D/ODL_Inputs_hold_test.csv', index = False)