...
def create_xml_for_vehicle(start, end):
    ...
    #select the yard
    new_df_vehicle_72GM = df_vehicle_72GM[df_vehicle_72GM['yard'] == 'ASY']
...
def create_xml_for_turf():
    df = pd.read_csv('/home/analytics/PycharmProjects/jsprit_create_xml/72GM/ASY/services_yard_Ambleside Yard')
...
if __name__ == '__main__':
    ...
    xml.append('</problem>')
    #print("\n".join(xml))
    with open('/home/analytics/PycharmProjects/jsprit_create_xml/72GM/ASY/problem_setup.xml', 'w') as f:
        f.write("\n".join(xml))
